...
import { ChevronRight, Clock, Tag, User, Calendar, ArrowLeft, CheckCircle, AlertTriangle, DollarSign, FileText, Building2, HelpCircle, TrendingUp, Award, ExternalLink } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <main id="main-content" className="py-12 bg-white" role="main">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Social Sharing */}
          <SocialSharing
            title="Complete Guide to SBA Loans in 2025"
            description="Everything you need to know about SBA loans in 2025. Complete guide covering SBA 7(a), SBA 504, microloans, requirements, application process, and approval strategies."
            url="/guides/complete-sba-loan-guide-2025"
            className="mb-8"
          />
        </div>
        </section>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div id="overview" className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 mb-12 border border-blue-100">
                  ...
                  <p className="text-gray-700 mb-4 leading-relaxed">
                    <Link href="/solutions/sba-loans" className="text-[#193a59] hover:underline font-medium">SBA loans</Link> remain one of the most attractive financing options for small businesses, offering competitive rates, longer repayment terms, and lower down payments than traditional bank loans. According to the <a href="https://www.sba.gov/" target="_blank" rel="noopener noreferrer" className="text-[#193a59] hover:underline inline-flex items-center">Small Business Administration <ExternalLink className="w-3 h-3 ml-1" /></a>, SBA-backed loans support over $25 billion in lending annually.
                  </p>
                  <p className="text-gray-700 mb-4 leading-relaxed">
