...
import heroImage from '@assets/Debt-Consolidation_1752510306630.jpeg';

export default function DebtConsolidationPage() {
  // Using simple working image URL 
  const contentImage = "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=800&h=500&fit=crop&crop=center";
