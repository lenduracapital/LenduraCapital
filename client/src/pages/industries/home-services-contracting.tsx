          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                ...
                <p>Lendura Capital understands these challenges and provides tailored financing solutions that help contractors and service providers grow their businesses, purchase equipment, and maintain steady cash flow.</p>
              </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real contractors who grew their businesses with Lendura Capital financing
            </p>
          </div>
