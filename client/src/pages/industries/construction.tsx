...
import { CheckCircle, ArrowLeft, Star, HardHat, Truck, Building } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-left max-w-4xl mt-8 md:mt-16">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Build your business with flexible financing for equipment, projects, and working capital needs.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                <p>Construction companies face unique challenges: project-based cash flow, equipment costs, material expenses, and payment delays from clients and general contractors.</p>
                <p>FundTek Capital Group understands the construction industry's cyclical nature and provides flexible financing solutions that help contractors manage cash flow and grow their businesses.</p>
              </div>
            ...
            <div className="relative">
              <img 
                ...
                alt="Construction work and equipment"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real construction companies that built their success with FundTek Capital Group financing
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-[#85abe4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Based on typical construction business needs, these solutions work best for contractors
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              Take advantage of our specialized financing solutions for construction companies
            </p>
          </div>
        </div>
      </section>
