...
import { CheckCircle, ArrowLeft, Star, Sparkles, Heart, Users } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-left max-w-4xl mt-8 md:mt-16">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Beautiful financing solutions for salons, spas, fitness centers, and wellness businesses.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-black mb-6 md:mb-8">
                Enhancing Beauty & Wellness
              </h2>
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                <p>Beauty and wellness businesses face unique challenges: equipment costs, inventory management, seasonal fluctuations, staff training, and maintaining competitive service offerings.</p>
                <p>FundTek Capital Group understands the beauty and wellness industry and provides flexible financing solutions that help salons, spas, and fitness centers enhance facilities and grow their client base.</p>
              </div>
            ...
            <div className="relative">
              <img 
                ...
                alt="Beauty and wellness business"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real beauty and wellness business owners who transformed their operations with FundTek Capital Group financing
            </p>
          </div>
            ...
            {[
              {
                ...
                story: "Used equipment financing to renovate salon and purchase new styling stations. Client satisfaction increased 40% and bookings doubled within 6 months.",
                funding: "$75,000 Equipment Financing"
              },
              {
                name: "Mark Thompson",
                company: "Elite Fitness Center",
                story: "Secured working capital to purchase cardio equipment and expand group fitness programs. Membership grew by 60% in first year.",
                funding: "$150,000 Term Loan"
              },
              {
                name: "Amy Chen",
                company: "Zen Wellness Spa",
                story: "Got line of credit to stock premium products and hire additional therapists. Revenue increased 80% and expanded service offerings.",
      ...
      <section className="py-16 md:py-24 bg-[#85abe4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Based on typical beauty and wellness needs, these solutions work best for personal care businesses
          </p>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              <h3 className="text-xl font-bold mb-4 text-white">Equipment Financing</h3>
              <p className="text-blue-100 mb-6">Perfect for salon equipment, fitness machines, and spa technology</p>
              <Button 
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              ...
              <p className="text-blue-100 mb-6">Ideal for renovations, expansions, and major business improvements</p>
              <Button 
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              ...
              <p className="text-blue-100 mb-6">Flexible working capital for inventory, marketing, and seasonal needs</p>
              <Button 
      ...
      <section className="py-16 md:py-24 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get the funding you need to upgrade equipment, renovate your space, and grow your beauty or wellness business
          </p>
