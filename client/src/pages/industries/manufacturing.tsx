...
import { CheckCircle, ArrowLeft, Star, Factory, Cog, Package } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 md:pt-40 pb-20 md:pb-32 bg-gradient-to-br from-[#85abe4] to-blue-600 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=1200&h=600&fit=crop')"
          }}
        />
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                <p>Manufacturing companies face unique challenges: equipment costs, raw material expenses, production cycles, quality control requirements, and managing large order fulfillment.</p>
                <p>FundTek Capital Group understands manufacturing operations and provides specialized financing solutions that help manufacturers scale production, upgrade equipment, and fulfill large contracts.</p>
              </div>
            ...
            <div className="relative">
              <img 
                ...
                alt="Manufacturing facility and equipment"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real manufacturers who scaled their operations with FundTek Capital Group financing
            </p>
          </div>
            ...
            {[
              {
                ...
                story: "Used equipment financing to purchase CNC machines and expand production capacity. Secured major automotive contract worth $2M annually.",
                funding: "$380,000 Equipment Financing"
              },
              {
                name: "Linda Zhang",
                company: "Zhang Manufacturing",
                story: "Secured working capital to purchase raw materials for large government contract. Completed project on time and under budget.",
                funding: "$250,000 Line of Credit"
              },
              {
                name: "James Patterson",
                company: "Metro Fabrication",
                story: "Got facility expansion loan to double production space and add assembly line. Production capacity increased 140% within 6 months.",
                funding: "$500,000 Term Loan"
              }
            ].map((story, index) => (
      ...
      <section className="py-16 md:py-24 bg-[#85abe4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Based on typical manufacturing needs, these solutions work best for production companies
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              ...
              <p className="text-blue-100 mb-6">Flexible working capital for raw materials and large order fulfillment</p>
              <Button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              Take advantage of our specialized financing solutions for manufacturing companies
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get the funding you need to purchase equipment, expand facilities, and fulfill larger contracts
          </p>
