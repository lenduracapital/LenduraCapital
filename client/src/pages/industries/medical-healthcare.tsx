          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                ...
                <p>FundTek Capital Group understands the healthcare industry and provides specialized financing solutions that help medical professionals focus on patient care while growing their practices.</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real healthcare professionals who expanded their practices with FundTek Capital Group financing
            </p>
          </div>
