...
import { CheckCircle, ArrowLeft, Star, ShoppingBag, Store, Package } from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-left max-w-4xl mt-8 md:mt-16">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
              Stock up for success with inventory financing, expansion capital, and seasonal working capital.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <div className="text-lg md:text-xl text-gray-700 mb-8 md:mb-12 leading-relaxed space-y-4">
                <p>Retail and e-commerce businesses face unique challenges: inventory management, seasonal sales fluctuations, expansion opportunities, and maintaining competitive pricing.</p>
                <p>FundTek Capital Group understands retail dynamics and provides flexible financing solutions that help retailers stock inventory, expand operations, and capitalize on growth opportunities.</p>
              </div>
              ...
              <ul className="space-y-4 mb-8 md:mb-12">
                {[
                  ...
                  "Store buildouts and renovations", 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real retail owners who expanded their businesses with FundTek Capital Group financing
            </p>
          </div>
            ...
            {[
              {
                ...
                story: "Used inventory financing to stock up for holiday season. Sales increased 80% and secured supplier discounts for bulk purchases.",
                funding: "$95,000 Inventory Financing"
              },
              {
                name: "Mike Chen",
                company: "Chen Electronics",
                story: "Secured working capital to launch e-commerce platform and expand online presence. Online sales now represent 60% of total revenue.",
                funding: "$120,000 Term Loan"
              },
              {
                name: "Emma Taylor",
                company: "Taylor Home Goods",
                story: "Got line of credit to manage seasonal cash flow and maintain inventory levels. Never missed a supplier payment during slow months.",
      ...
      <section className="py-16 md:py-24 bg-[#85abe4] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
            Based on typical retail needs, these solutions work best for retail and e-commerce businesses
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
              ...
              <p className="text-blue-100 mb-6">Financing for store equipment, point-of-sale systems, and business technology</p>
              <Button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Accelerate Your Retail Business Growth
            </h2>
            <p className="text-lg md:text-xl text-gray-600">
              Take advantage of our specialized financing solutions for retail and e-commerce businesses
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get the funding you need to stock inventory, expand locations, and grow your retail operations
          </p>
