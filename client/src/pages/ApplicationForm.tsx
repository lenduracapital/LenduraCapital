...
import { CheckCircle, Phone, Mail, Building, DollarSign } from "lucide-react";
...
export default function ApplicationForm({ variant = 'apply' }: ApplicationFormProps) {
  ...
  const validateAll = () => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      const businessFields = ['businessName', 'dbaName', 'businessAddress', 'city', 'state', 'zipCode', 'ein', 'businessType', 'timeInBusiness'];
      const financialFields = ['monthlyRevenue', 'loanAmount', 'loanPurpose', 'creditScore'];
      const consentFields = ['consentToCommunications', 'consentToCredit', 'electronicSignature'];

      if (errorFields.some(field => contactFields.includes(field))) {
        contactSectionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' });
      } else if (errorFields.some(field => businessFields.includes(field))) {
      ...
      } else if (errorFields.some(field => consentFields.includes(field))) {
        consentSectionRef.current?.scrollIntoView({ behavior: 'smooth', block: 'start' });
      }
    }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
                Complete your application below. All sections are required for processing. We'll review your information and contact you with funding options tailored to your business needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="py-8 sm:py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8 space-y-12">
              ...
              <div ref={contactSectionRef} className="space-y-6">
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">Your personal details</p>
                </div>
              ...
              <div ref={businessSectionRef} className="space-y-6">
                <div className="text-center mb-8">
              ...
              <div ref={financialSectionRef} className="space-y-6">
                <div className="text-center mb-8">
              ...
              {/* Section 4: Review & Consent */}
              <div ref={consentSectionRef} className="space-y-6">
                <div className="text-center mb-8">
                  <CheckCircle className="w-12 h-12 text-[#193a59] mx-auto mb-4" />
                  <h2 className="text-2xl font-bold text-[#193a59] mb-2">Review & Consent</h2>
