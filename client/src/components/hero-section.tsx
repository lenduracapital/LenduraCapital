      ...
      <div className="relative z-10 h-full flex items-center justify-start px-4 sm:px-6 lg:px-8 pt-16 md:pt-20">
        <div className="max-w-md text-left ml-0 md:ml-0 lg:ml-0 w-full md:w-auto">
          <h1 className="responsive-heading-lg font-bold text-white mb-4 leading-tight hero-text" 
              style={{ 
                textShadow: '3px 3px 6px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8), -1px -1px 2px rgba(0,0,0,0.7)',
                fontWeight: '900'
              }}>
            Flexible Financing for <span style={{ color: '#85abe4', textShadow: '3px 3px 6px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8)' }}>Every Industry</span>
          </h1>
          <p className="text-white text-base md:text-lg mb-6 leading-relaxed font-semibold" 
             style={{ 
               textShadow: '2px 2px 5px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8), -1px -1px 2px rgba(0,0,0,0.7)'
             }}>
            Empower your business with <span className="text-[#85abe4] font-bold" style={{ textShadow: '2px 2px 5px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8)' }}>custom tailored</span> financial and <span className="text-[#85abe4] font-bold" style={{ textShadow: '2px 2px 5px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8)' }}>business solutions</span>
          </p>
          <p className="text-white text-base md:text-lg mb-8 font-semibold" 
             style={{ 
               textShadow: '2px 2px 5px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8), -1px -1px 2px rgba(0,0,0,0.7)'
             }}>
            Call us at <span className="text-[#85abe4] font-bold" style={{ textShadow: '2px 2px 5px rgba(0,0,0,0.9), 1px 1px 3px rgba(0,0,0,0.8)' }}>(305) 307-4658</span> to see your options
          </p>
