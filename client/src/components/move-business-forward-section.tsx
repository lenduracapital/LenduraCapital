    ...
    <section className="pt-8 pb-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-6" style={{ color: '#2563eb' }}>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center flex flex-col h-full">
              <div className="mb-6">
                <svg className="w-16 h-16 mx-auto" style={{ color: '#2563eb' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center flex flex-col h-full">
              <div className="mb-6">
                <Clock className="w-16 h-16 mx-auto" style={{ color: '#2563eb' }} />
              </div>
            ...
            <div className="text-center flex flex-col h-full">
              <div className="mb-6">
                <DollarSign className="w-16 h-16 mx-auto" style={{ color: '#2563eb' }} />
              </div>
