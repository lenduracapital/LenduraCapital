        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4 min-h-[4rem] flex items-center justify-center">Expert financing specialists</h3>
            ...
            <div className="text-center flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4 min-h-[4rem] flex items-center justify-center">Fast turnaround</h3>
              <p className="text-gray-600 flex-1">
            ...
            <div className="text-center flex flex-col h-full">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4 min-h-[4rem] flex items-center justify-center">Competitive financing solutions</h3>
              <p className="text-gray-600 flex-1">
