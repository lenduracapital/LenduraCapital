...
export function BlogThumbnailImage(props: Omit<UnsplashImageProps, 'width' | 'height' | 'aspectRatio'>) {
  return (
    <UnsplashImage
      {...props}
      width={400}
...
export function BlogHeroImage(props: Omit<UnsplashImageProps, 'width' | 'height' | 'aspectRatio'>) {
  return (
    <UnsplashImage
      {...props}
      width={1200}
...
export function GuideThumbnailImage(props: Omit<UnsplashImageProps, 'width' | 'height' | 'aspectRatio'>) {
  return (
    <UnsplashImage
      {...props}
      width={400}
